...
import { ZUserLogin } from "@togethertube/schema/user";
...
const LoginForm = () => {
  ...
  const handleGoogleLogin = () => {
    window.location.href = "/auth/google"; // Redirect to your backend Google OAuth route
  };
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        <p className="text-center text-gray-400 text-sm">
          ...
          >
            <LogIn className="w-4 h-4 rotate-180" /> Register
          </Link>
        </p>
      </form>
    </div>
